# this module runs linear regression while controlling for two covariates
# requires all data to be preprocessed using the BrainSuite Functional Pipeline
# sample config file found ../src/stats/sample_config_stats.ini
# sample demographic information found ../src/stats/sample_demo_linear_regr.csv

#	input: config_file
#	output: 

# inquiries may be made in our forum: http://forums.brainsuite.org/
# authors: ajoshi and sychoi at Biomedical Imaging Laboratory, University of Southern California
