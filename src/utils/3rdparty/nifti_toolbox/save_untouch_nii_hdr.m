...
write_header_save_untouch_nii_hdr(hdr, fid);

return;					% save_nii_hdr
end

%---------------------------------------------------------------------
function write_header_save_untouch_nii_hdr(hdr, fid)
...
header_key_save_untouch_nii_hdr(fid, hdr.hk);
image_dimension_save_untouch_nii_hdr(fid, hdr.dime);
data_history_save_untouch_nii_hdr(fid, hdr.hist);
...
%---------------------------------------------------------------------
function header_key_save_untouch_nii_hdr(fid, hk)
...
%---------------------------------------------------------------------
function image_dimension_save_untouch_nii_hdr(fid, dime)
...
%---------------------------------------------------------------------
function data_history_save_untouch_nii_hdr(fid, hist)
