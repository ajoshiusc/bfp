...
if fid < 0,
   ...
   fseek(fid,0,'bof');
   hdr = read_header_load_untouch_nii_hdr(fid);
   fclose(fid);
end
...
%---------------------------------------------------------------------
function [ dsr ] = read_header_load_untouch_nii_hdr(fid)
...
dsr.hk   = header_key_load_untouch_nii_hdr(fid);
dsr.dime = image_dimension_load_untouch_nii_hdr(fid);
dsr.hist = data_history_load_untouch_nii_hdr(fid);
...
%---------------------------------------------------------------------
function [ hk ] = header_key_load_untouch_nii_hdr(fid)
...
%---------------------------------------------------------------------
function [ dime ] = image_dimension_load_untouch_nii_hdr(fid)
...
%---------------------------------------------------------------------
function [ hist ] = data_history_load_untouch_nii_hdr(fid)
