...
load('../supp_data/bci_grayordinates_vol_ind.mat','bci_vol_ind');

v=load_nii_BIG_Lab('/home/ajoshi/coding_ground/svreg-matlab/BCI-DNI_brain_atlas/BCI-DNI_brain.label.nii.gz');
v2=v;v2.img=0*v2.img;
v2.img(bci_vol_ind(ind))=v.img(bci_vol_ind(ind));
save_untouch_nii_gz(v2,'Vol_BCI_grayord32k.label.nii.gz');
