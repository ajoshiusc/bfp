...
l= readdfs('/ImagePTE1/ajoshi/code_farm/svreg/USCBrainMulti/Economo/BCI-DNI_Economo.left.mid.cortex.dfs');

r= readdfs('/ImagePTE1/ajoshi/code_farm/svreg/USCBrainMulti/Economo/BCI-DNI_Economo.right.mid.cortex.dfs');
...
vl = load_nii('/ImagePTE1/ajoshi/code_farm/svreg/USCBrainMulti/Economo/BCI-DNI_Economo.label.nii.gz');

vol_labs=0*vl.img(bci_vol_ind); % Set volume labels to 0

% Concatenate surface and volume labels
labels=[surf_labs;vol_labs(1+length(surf_labs):end)];

% Read XML and create lookup table
xml1 = xml2struct('/ImagePTE1/ajoshi/code_farm/svreg/USCBrainMulti/Economo/brainsuite_labeldescription.xml');
...
save('Economo_grayordinate_labels.mat', 'LookUpTable', 'labels');
